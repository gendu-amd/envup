...
- Documentation is consolidated around the English and Chinese READMEs, with
  architecture and contribution details kept separate.
...
- Modular dotfiles and development-environment manager with zsh, Git, tmux,
  fzf, zoxide, Atuin, and Neovim modules.
- Minimal, standard, and full installation profiles.
- Safe symlinking, backups, dry-run support, status and doctor commands.
- Cross-platform package installation and basic CI coverage.
