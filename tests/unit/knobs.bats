#!/usr/bin/env bats
# Every ENVUP_* name must be documented or explicitly internal.
...
INTERNAL=(
    ...
    ENVUP_HOME              # checkout root derived from the resolved envup executable
    ENVUP_LEGACY_STATE_DIR  # old unscoped state path, retained only for migration
